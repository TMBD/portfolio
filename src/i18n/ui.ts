...
export const ui = {
  en: {
    ...
    "home.mainSkills": "Main Technical Skills",
    "home.topExperiences": "Top Experiences",
    "home.topProjects": "Top Projects",
    "cert.empty": "Certifications are on the way — this space is ready for them.",
    "cert.title": "Certifications",
    "page.experience.subtitle": "My professional journey so far.",
  ...
  fr: {
    ...
    "home.mainSkills": "Compétences techniques principales",
    "home.topExperiences": "Expériences principales",
    "home.topProjects": "Projets principaux",
    "cert.empty": "Les certifications arrivent — cet espace est prêt à les accueillir.",
    "cert.title": "Certifications",
    "page.experience.subtitle": "Mon parcours professionnel jusqu'ici.",
